...
//go:embed html/challenge.html
var challengeTemplate string

// https://github.com/witer33/fiberpow/blob/main/main.go
...
func ( s *Server ) NewJSChallenge(config ...JSChallengeConfig) fiber.Handler {
	var cfg JSChallengeConfig
	if len(config) > 0 {
		cfg = config[0]
	}
